...
local config = {
    ...
    GROUPS = {
        Vendors = {
            ...
            npcs = {"vendor_walmart", "vendor_doctor", "vendor_a", "vendor_dogman", "vendor_spy", "vendor_doctor2",
                    "vendor_cowman", "vendor_bloxmart", "vendor_jewelry", "vendor_Chef", "xiaoleung"}
        },
        ...
        morning = {
            ...
            npcs = {"cowman", "ninja_bae", "gentleman", "gentlecow", "starcow", "police_b", "hba", "cowman2", "cowman3",
                    ...
                    "HideHusband", "timthespam", "Prabzil", "peter", "Walkingman", "grandma", "hellotatta"}
        },
        ...
        afternoon = {
            ...
            npcs = {"catman", "afternoon_cowman", "eagle", "illidan", "mmp", "ninjapark", "canada", "b", "police_a",
                    ...
                    "biking", "snakeman", "Indian", "Amona", "BarbieBankz", "Crimson", "Dxummy_gaurd", "IconicFatma",
                    "KlTSUBEE", "Mewrila", "Nasynia", "HideHusband", "timthespamm", "STARCODEE_GUN", "TheOdd", "peter",
                    "payleey", "theman"}
        },
        ...
        Night = {
            ...
            npcs = {"ninja", "savage", "sol", "night_cowman", "gentlecolor", "bleus", "ggocalcon", "a", "night_cowman2",
                    ...
                    "night_ninja_bae", "sunglasscow", "purpleman", "runner", "supreme", "eightman", "Amona", "Crimson",
        ...
        NightWatch = {
            ...
            npcs = {"vendor_ninja(Lv.100)", "nightwatch_zombie", "nightwatch_pumpkin", "nightwatch_blackcat",
                    "police_c", "nightwatch_zombie2", "nightwatch_crazy", "nightwatch_savage", "nightwatch_nudeman",
                    "nightwatch_flower", "nightwatch_eagle", "nightwatch_DeathDollieOriginal", "nightwatch_Goblin",
                    "nightwatch_Skeleton", "nightwatch_zoechickie"}
        }
    }
}
